...
from app.routes.v1.schemas.user import UserCreate, UserCreateResponse
from app.utility.database import get_db
from app.utility.security import hash_email
...
async def login_user(user: UserCreate, request: Request, db: AsyncSession = Depends(get_db)):
    """
    ...
    Returns:
        UserCreateResponse: Response containing user details upon successful login
    ...
    return UserCreateResponse(user_id=user_data.id)
